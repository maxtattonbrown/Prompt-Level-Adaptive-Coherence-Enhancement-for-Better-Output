...
```bash
git clone https://github.com/maxtattonbrown/Prompt-Level-Adaptive-Coherence-Enhancement-for-Better-Output.git
cd Prompt-Level-Adaptive-Coherence-Enhancement-for-Better-Output
./install.sh
```
